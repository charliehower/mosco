...
class YBOpenApi{
    ...
    public function init($appID = '', $appSecret = '', $callback_url = '') {
        $this->_config['appid'] = empty($appID) ? env('YB_APPID') : $appID;
        $this->_config['seckey'] = empty($appSecret) ? env('YB_APPSECRET') : $appSecret;
        $this->_config['backurl'] = empty($callback_url) ? env('YB_CALLBACK') : $callback_url;
